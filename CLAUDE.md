...
- **Requirements Standard**: All requirements MUST follow EARS pattern (Easy Approach to Requirements Syntax) - see `.sdd/steering/requirements.md` for complete template and examples.
...
- **TDD Mandatory**: All implementation MUST follow Test-Driven Development (Red-Green-Refactor)
  - Write failing test first (Red)
  - Implement minimal code to pass (Green)
  - Refactor while keeping tests green
  - See `.sdd/steering/tech.md` for complete TDD guidelines
